"""
Django settings for pirotech project.
...
SECRET_KEY = 'django-insecure-74jvbli^3zl+y07-8mk(qw42m&a!nyni+txou2ylvz)o$)w%yd'
...
DATABASES = {
   'default': {
        ...
        'PASSWORD': '181012',  # troque pela senha que você usa no pgAdmin
